...
import { 
  ...
  Save, ArrowRightLeft, Download, Layers, Check, Info
} from 'lucide-react';
                                ...
                                <div key={asset.id} className="flex gap-2 items-center bg-slate-50 p-2 rounded-xl border border-slate-100">
                                    ...
                                    <div className="flex-1 grid grid-cols-2 gap-2 max-w-[320px]">
                                        <div className="h-10 bg-white border border-slate-300 rounded-lg flex items-center px-2 focus-within:ring-1 focus-within:ring-amber-500">
                                            <input type="text" placeholder="代號" value={asset.code} onChange={(e)=>updateAsset(asset.id, 'code', e.target.value)} className="w-full h-full text-sm font-bold uppercase text-slate-800 placeholder:text-slate-400 border-none focus:ring-0 bg-transparent p-0"/>
                                        </div>
                                        <div className="h-10 bg-white border border-slate-300 rounded-lg flex items-center px-2 focus-within:ring-1 focus-within:ring-amber-500 relative">
                                            <input type="number" placeholder="價格" value={asset.price} onChange={(e)=>updateAsset(asset.id, 'price', e.target.value)} className="w-full h-full text-sm text-slate-800 placeholder:text-slate-400 border-none focus:ring-0 bg-transparent p-0 pl-3"/><span className="absolute left-2 text-slate-400 text-xs">$</span>
                                        </div>
                                    </div>
